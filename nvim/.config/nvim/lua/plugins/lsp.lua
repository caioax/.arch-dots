return {
	{
		...
		config = function()
			-- Setup do Mason (Interface Gráfica)
			require("mason").setup()

			-- Setup do Instalador de ferramentas
			require("mason-tool-installer").setup({
				ensure_installed = {
					...
					-- === FORMATADORES (Estética) ===
					"stylua", -- Lua
					"prettier", -- Web (HTML, CSS, JS, TS, JSON, YAML, Markdown)
					"black", -- Python
					"isort", -- Python (Organizar Imports)
					"shfmt", -- Shell Script

					-- === LINTERS (Erros extras) ===
					"eslint_d", -- JavaScript/TypeScript
				},
			})

			-- Setup do Mason-LSPConfig com HANDLERS
			require("mason-lspconfig").setup({
				...
				-- Handlers definem como ligar cada servidor
				handlers = {
